...
public:
    // Must have a constructor explicitly defined
    SignalProcessor() {} // Add this explicit constructor
...
// Update the bindings to explicitly bind the constructor
EMSCRIPTEN_BINDINGS(signal_processor_module) {
    emscripten::class_<SignalProcessor>("SignalProcessor")
        .constructor<>()  // Explicitly bind the default constructor
